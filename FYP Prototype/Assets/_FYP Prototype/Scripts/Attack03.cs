...
public class Attack03 : MonoBehaviour
{
	...
	void OnTriggerEnter(Collider other)
	{
		...
		{
			if (other.gameObject.transform.parent.gameObject.GetComponent<PlayerHealth> () != selfHealth && selfControl.animation.GetCurrentAnimatorStateInfo (0).IsName ("Attack03")) {
